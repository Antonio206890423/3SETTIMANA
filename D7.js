...
const n = 2;
console.log(incrementaArray(numeri, n));

/* ESERCIZIO 7 (map)
  Scrivi una funzione che, dato un array di stringhe, ritorni un nuovo array contenente le lunghezze delle rispettive stringhe dell'array di partenza
  es.: ["EPICODE", "is", "great"] => [7, 2, 5]
*/
function lunghezzeArray(array) {
  return array.map((str) => str.length);
}

const stringhe = ["EPICODE", "is", "great"];
console.log("Lunghezza array", lunghezzeArray(stringhe));
...
console.log("Numeri dispari da 1 a 99", numeriDispari());
